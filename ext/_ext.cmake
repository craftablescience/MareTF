...
# QCodeEditor
if(MARETF_BUILD_GUI)
    file(GLOB_RECURSE QCODEEDITOR_INC LIST_DIRECTORIES OFF CONFIGURE_DEPENDS "${CMAKE_CURRENT_LIST_DIR}/qcodeeditor/include/*")
    file(GLOB_RECURSE QCODEEDITOR_RES LIST_DIRECTORIES OFF CONFIGURE_DEPENDS "${CMAKE_CURRENT_LIST_DIR}/qcodeeditor/resources/*.qrc")
    file(GLOB_RECURSE QCODEEDITOR_SRC LIST_DIRECTORIES OFF CONFIGURE_DEPENDS "${CMAKE_CURRENT_LIST_DIR}/qcodeeditor/src/*")
    add_library(QCodeEditor STATIC ${QCODEEDITOR_INC} ${QCODEEDITOR_RES} ${QCODEEDITOR_SRC})
    target_include_directories(QCodeEditor PUBLIC "${CMAKE_CURRENT_LIST_DIR}/qcodeeditor/include")
    target_use_qt(QCodeEditor)
endif()

...
const std::vector<vtfpp::VTF::Flags> VTF_FLAGS_E{
	...
	vtfpp::VTF::FLAG_LOAD_LOWEST_MIPS,
	...
	vtfpp::VTF::FLAG_ONE_OVER_MIP_LEVEL_IN_ALPHA,
	vtfpp::VTF::FLAG_PREMULTIPLY_COLOR_BY_ONE_OVER_MIP_LEVEL,
	vtfpp::VTF::FLAG_NORMAL_TO_DUDV,
	vtfpp::VTF::FLAG_ALPHA_TEST_MIP_GENERATION,
	vtfpp::VTF::FLAG_NO_DEPTH_BUFFER,
	vtfpp::VTF::FLAG_NICE_FILTERED,
	vtfpp::VTF::FLAG_CLAMP_U,
	vtfpp::VTF::FLAG_VERTEX_TEXTURE,
	vtfpp::VTF::FLAG_SSBUMP,
	vtfpp::VTF::FLAG_UNFILTERABLE_OK,
	vtfpp::VTF::FLAG_BORDER,
	vtfpp::VTF::FLAG_SPECVAR_RED,
	vtfpp::VTF::FLAG_SPECVAR_ALPHA,
};
const std::vector<std::string_view> VTF_FLAGS_S{
	...
	"NO_DEBUG_OVERRIDE",
	"SINGLE_COPY",
	"ONE_OVER_MIP_LEVEL_IN_ALPHA",
	"PREMULTIPLY_COLOR_BY_ONE_OVER_MIP_LEVEL",
	"NORMAL_TO_DUDV",
	"ALPHA_TEST_MIP_GENERATION",
	"NO_DEPTH_BUFFER",
	"NICE_FILTERED",
	"CLAMP_U",
	"VERTEX_TEXTURE",

...
const std::vector<vtfpp::ImageFormat> IMAGE_FORMAT_E{
	...
	vtfpp::ImageFormat::SOURCEPP_BGRA8888_HDR,
	...
	vtfpp::ImageFormat::SOURCEPP_RGBA16161616_HDR,
	...
	vtfpp::ImageFormat::SOURCEPP_CONSOLE_RGBA16161616_HDR,
	vtfpp::ImageFormat::CONSOLE_BGRX8888_LE,
	vtfpp::ImageFormat::CONSOLE_BGRA8888_LE,
	vtfpp::ImageFormat::TITANFALL_BC6H,
...
const std::vector<vtfpp::Resource::Type> RESOURCE_TYPE_E{
	...
	vtfpp::Resource::TYPE_PARALLAX_CORRECTED_CUBEMAP,
